...
class PCWrappedSelector extends React.Component {
    ...
    onClickOption (e) {
        ...
        const {listLength, dataSource} = this.props;
        const renderData = this.getRenderData(0, listLength, dataSource.data);
        this.setState({
    ...
    render () {
        ...
        const placeholder = currentSelectedItem && currentSelectedItem.title ? currentSelectedItem.title : '搜索';
        return (
...
function Selector (WrappedComponent) {
    class FinalComponent extends WrappedComponent {
        constructor (props) {
            ...
            this.props.onChange && this.props.onChange(currentSelectedItem);
        }
        // 更新renderData
        componentWillReceiveProps (nextprops) {
            if (nextprops.dataSource !== this.props.dataSource) {
                ...
                if (nextprops.dataSource.shouldRefreshSelector) {
                    this.setState({
                        currentSelectedItem: {},
                        searchKey: '',
                    });
